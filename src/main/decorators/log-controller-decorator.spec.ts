...
import { LogControllerDecotator } from './log-controller-decorator'
...
const makeSut = (): SutTypes => {
  ...
  const sut = new LogControllerDecotator(controllerStub, logErrorRepositoryStub)
  return {
    sut,
    controllerStub,
